...
import Data.BitCode.LLVM.Value    (Value, Const, Symbol(..), ValueSymbolTable, ValueSymbolEntry, symbolValue, symbolName, entryName)
...
nth' n = fromMaybe (fail "Index out of range") . fmap pure . nth n
